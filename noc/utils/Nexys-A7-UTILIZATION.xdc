...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pil_rst_IBUF]

##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { pil_rst }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
